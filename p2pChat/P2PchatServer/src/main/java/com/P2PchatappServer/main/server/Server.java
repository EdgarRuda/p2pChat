package com.P2PchatappServer.main.server;
...
public class Server {
   ...
   @Autowired
   public void serverLaunch() throws Exception {

        // Waiting for Connection of Client1 on Port 7070
        // ////////////////////////////////////////////////

        // open serverSocket on Port 8000
        DatagramSocket serverSocket1 = new DatagramSocket(8000);
        ...
        // Waiting for Connection of Client2 on Port 8001
        // ////////////////////////////////////////////////
